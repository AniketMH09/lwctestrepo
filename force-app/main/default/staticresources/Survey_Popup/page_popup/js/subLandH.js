...
function createInvite() {
    ...
    n = '<style type="text/css">         td{text-align: center;}         .normalStyle{font: 15px "Helvetica Neue", Helvetica, Arial, sans-serif}         .boldStyle{font: bold 20px "Helvetica Neue", Helvetica, Arial, sans-serif;}         .smallItalic{font: italic 10px "Helvetica Neue", Helvetica, Arial, sans-serif;}     <\/style>     <div style="background-color: #fff; position: absolute; width:' + inviteWidth + 'px; ">     <table style="width: 100%; margin: auto; border: 1px solid black;">         <tr><td><img src="' + imageDir + 'HFSLogo_300.png" alt="HFS Logo" /><\/td><\/tr>         <tr><td class="boldStyle">We want to hear from you!<\/td><\/tr>         <tr><td class="normalStyle"><br />As a valued customer, you are invited to participate in a 3 minute online survey at the end of your visit which will be used to improve services we offer.<br /><br /><\/td><\/tr>         <tr><td class="boldStyle">Please click below to take the survey.<\/td><\/tr>         <tr><td><table style="margin: auto;"><tr><td style="width: 37px;">&nbsp;<\/td><td><a onclick="acceptSurvey();" style="cursor: pointer;"><img src="' + imageDir + 'yes.png" alt="Yes! When I complete my transaction" /><\/a><\/td><td style="width: 37px;"><\/td><\/tr>             <tr><td>&nbsp;<\/td><td><a  onclick="declineSurvey();" style="cursor: pointer;"><img src="' + imageDir + 'no.png" alt="No, thanks. Maybe next time." /><\/a><\/td><td>&nbsp;<\/td><\/tr><\/table><\/td><\/tr>         <tr><td class="smallItalic">Review the <a href="https://survey3.sendyouropinions.com/images/privacy.htm" target="_blank">Privacy Statment<\/a> for this survey.<\/td><\/tr>     <\/table>     <\/div>';
    ...
    document.write('<div id="surveylayer" style="position:absolute; left:0; top:50%; margin-top: -' + inviteHeight / 2 + "px; z-index:12; visibility: hidden; border:1px #7d7d7d solid; width:" + (inviteWidth + 2) + "px;height=" + inviteHeight + 'px;">' + n + "<\/div>")
}
...
var isIE = !1,
    ...
    job = "w6277HAGW",
    imageDir = "./Images/",
    launchURL = "./slaunchLandH.html",
    icName = "iHondaAcuraSurvey",
    tVar, iPopDel = 0,
    webID, browser, NthVal, centobj;
webID || (webID = "0");
browser = function() {
