    ...
    redirectToMyAccount : function(component,event,helper){
     ...
     redirectToDashBoard : function(component,event,helper){
      ...
      navigateToCaseDetails:function(component,event,helper){
        ...
        console.log('component.get("v.ClosedDDCCaseId"): '+component.get("v.ClosedDDCCaseId")); 
       console.log('component.get("v.caseStatus"): '+component.get("v.caseStatus"));
        var caseId;  
        if(component.get("v.caseStatus")==='Closed')
        {
            caseId=component.get("v.ClosedDDCCaseId");
          sessionStorage.setItem('supportRequestId', component.get("v.ClosedDDCCaseId"));  
        }else{
