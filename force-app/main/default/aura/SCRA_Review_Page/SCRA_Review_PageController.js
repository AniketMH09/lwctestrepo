({
    ...
    doInit : function (component, event, helper) {
       ...
       component.set("v.strFaAccountDisp", component.get("v.strFaAccount"));
        ...
        component.set("v.activedutydateDisp", component.get("v.activedutydate"));
        component.set("v.strbranchofserviceDisp", component.get("v.strbranchofservice"));
        component.set("v.strrequestoptionDisp", component.get("v.strrequestoption"));
        component.set("v.strAdditionalInfoDisp", component.get("v.strAdditionalInfo"));
...
*/        
    ...
    redirectToHome : function(component,event,helper){
       ...
       if(checkUser=='false' && sacRecId!='undefined' && sacRecId!=null && sacRecId!=='')
       {
           ...
           //window.history.back(); 
           window.location.href='https://poc.acura.americanhondafinance.co';
       }  
    },*/
