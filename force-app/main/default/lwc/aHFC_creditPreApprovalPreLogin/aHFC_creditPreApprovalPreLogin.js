/* Component Name   :    aHFC_creditPreApprovalPreLogin
 * @Description      :   LWC for sub menu credit pre approval for pre login page
 * Modification Log  :
 * ------------------------------------------------------------------------------------------------------------------ 
 * Developer                          Date                    Description
 * ------------------------------------------------------------------------------------------------------------------
 * Sagar Ghadigaonkar                 Aug 23 2021            LWC for sub menu credit pre approval for pre login page
...
export default class AHFC_creditPreApproval extends NavigationMixin(LightningElement) {
    ...
    currentUserAlias;
    error;
    @wire(getRecord, { recordId: Id, fields: [UserNameFld, userEmailFld, userIsActiveFld, userAliasFld,UserFirstName ]}) 
