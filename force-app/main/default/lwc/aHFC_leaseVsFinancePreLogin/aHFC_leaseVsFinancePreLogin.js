/* Component Name   :    aHFC_leaseVsFinancePreLogin
* @Description      :    LWC for sub menu lease vs finance for pre login page
* Modification Log  :
* ------------------------------------------------------------------------------------------------------------------ 
* Developer                          Date                    Description
* ------------------------------------------------------------------------------------------------------------------
* Sagar Ghadigaonkar                 Aug 23 2021             LWC for sub menu lease vs finance for pre login page
...
onPaginationClick(event) {
    ...
    console.log('transformtype >>>>>> '+event.currentTarget.dataset.transformtype);
