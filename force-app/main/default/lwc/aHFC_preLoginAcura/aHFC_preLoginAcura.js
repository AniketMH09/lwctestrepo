...
export default class AHFC_preLoginAcura extends NavigationMixin(LightningElement) {
    ...
    navigateToLogin() {
        ...
        let loginUrl = acuraLoginUrl + '&RelayState=/s/ciam-login-successfull?Brand=acura';
    ...
    navigateToRegistration() {
        ...
        let registrationURL = acuraLoginUrl + '&RelayState=/s/ciam-login-successfull?Brand=acura';
