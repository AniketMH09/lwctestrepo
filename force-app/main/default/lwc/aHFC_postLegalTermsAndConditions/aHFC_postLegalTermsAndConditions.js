...
* ---------------------------------------------------------------------------------------------------
* Sagar Ghadigaonkar                 Nov 16 2022            bug fix for 21917
*******************************************************************************************************/
...
export default class AHFC_postLegalTermsAndConditions extends NavigationMixin(LightningElement) {
    @track cutOffTime = AHFC_CutOffTime; //Added by Narain 
    @track privacyPolicyPdfUrl = AHFC_Privacy_Policy_PDF; //added by sagar bug fix 21917
    @track labels = labels;
    ...
    connectedCallback() {
        ...
        let contactUsPageUrl= basePath + "/contact-us-post-login";
