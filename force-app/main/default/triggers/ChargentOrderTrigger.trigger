/*******************************************************************************************************
    ...
    * @group    :  
    * @group-content : 
    * @description : THIS TRIGGER GETS INVOKED WHENEVER A PAYMENT IS CREATED AND/OR UPDATED.
********************************************************************************************************/
trigger ChargentOrderTrigger on ChargentOrders__ChargentOrder__c(after insert, after update, before insert, before update) {
    ...
    if (Trigger.isInsert && Trigger.isBefore) {
        ...
        if (Trigger.isUpdate && Trigger.isAfter) {
         ...
         /*******************************************************************************************************
                    SMS NOTIFICATION LOGIC : BYPASSES THE SMS NOTIFICATION LOGIC FOR INTEGRATION PROFILE/USERS   
         *******************************************************************************************************/
